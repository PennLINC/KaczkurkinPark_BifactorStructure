...
#Global model
AddGlobal <- gam(averageCT ~ s(age) + sex + averageManualRating + Add, method="REML", data = data.NMF)
...
#Global model
AgrGlobal <- gam(averageCT ~ s(age) + sex + averageManualRating + Agr, method="REML", data = data.NMF)
...
#Global model
ConGlobal <- gam(averageCT ~ s(age) + sex + averageManualRating + Con, method="REML", data = data.NMF)
...
#Global model
GadGlobal <- gam(averageCT ~ s(age) + sex + averageManualRating + Gad, method="REML", data = data.NMF)
...
#Global model
MddGlobal <- gam(averageCT ~ s(age) + sex + averageManualRating + Mdd, method="REML", data = data.NMF)
...
#Global model
OcdGlobal <- gam(averageCT ~ s(age) + sex + averageManualRating + Ocd, method="REML", data = data.NMF)
...
#Global model
OddGlobal <- gam(averageCT ~ s(age) + sex + averageManualRating + Odd, method="REML", data = data.NMF)
...
#Global model
PsGlobal <- gam(averageCT ~ s(age) + sex + averageManualRating + Ps, method="REML", data = data.NMF)
...
#Global model
PtdGlobal <- gam(averageCT ~ s(age) + sex + averageManualRating + Ptd, method="REML", data = data.NMF)
...
#Global model
SepGlobal <- gam(averageCT ~ s(age) + sex + averageManualRating + Sep, method="REML", data = data.NMF)
...
#Global model
SocGlobal <- gam(averageCT ~ s(age) + sex + averageManualRating + Soc, method="REML", data = data.NMF)
...
#Global model
SphGlobal <- gam(averageCT ~ s(age) + sex + averageManualRating + Sph, method="REML", data = data.NMF)
